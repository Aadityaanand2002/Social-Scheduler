                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
                        ...
                        <div className="mt-6 w-full flex justify-center">
                            <button
                                ...
                                className="w-full py-3 px-4 bg-white border border-slate-200 text-slate-700 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-slate-300 hover:shadow-sm"
                            >
                                ...
                                {loginState ? "Sign in with Google" : "Sign up with Google"}
                            </button>
                        </div>

            ...
            <div className="relative max-w-[1400px] w-full mx-auto px-4 sm:px-6 lg:px-8 z-10 flex flex-col lg:flex-row items-center mt-12 lg:mt-0">
                ...
                <div className="flex-1 w-full text-left lg:pr-10 z-20">
                    <h1 className="font-bold text-slate-900 tracking-tighter leading-[0.9] flex flex-col gap-2">
                        <TypewriterText 
                            text="Schedule smarter." 
                            className="text-6xl md:text-7xl lg:text-[90px] xl:text-[110px] opacity-90 hover:opacity-100 transition-opacity" 
                            delay={0.1} 
                        />
                        <TypewriterText 
                            text="Grow faster." 
                            className="whitespace-nowrap text-6xl md:text-7xl lg:text-[90px] xl:text-[110px] text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 drop-shadow-sm" 
                            delay={0.1} 
                        />
                    </h1>
                    ...
                    <p className="mt-12 text-xl lg:text-3xl text-slate-600 font-light max-w-2xl leading-snug tracking-tight">
                        <TypewriterText 
                            text="Break free from manual posting. Let our intelligence engine craft, schedule, and grow your audience while you sleep." 
                            delay={0.1} 
                        />
                    </p>

    ...
    >
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors">
          <div
            className="size-8 rounded-full bg-gradient-to-br from-red-400 to-pink-400
        ...
        <button
          onClick={() => {
            logout();
            navigate("/login"); // Fixed: Actually using the navigate hook!
          }}
          className="mt-1 flex items-center gap-2 px-3 py-2 w-full
          rounded text-sm text-slate-500 hover:bg-red-50
